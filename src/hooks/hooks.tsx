...
export function useFetchSingleMovie(id: string) {
  const [fetchSingleMovieStatus, setFetchSingleMovieStatus] = useState(
    FetchStatus.DEFAULT,
  );
...
export function useFetchSingleMovieCredit(id: string) {
  const [fetchSingleMovieCreditStatus, setFetchSingleMovieCreditStatus] =
    useState(FetchStatus.DEFAULT);
...
export function useFetchTopRated() {
  const [fetchTopRatedStatus, setFetchTopRatedStatus] = useState(
    FetchStatus.DEFAULT,
  );
